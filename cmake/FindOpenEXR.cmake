...
#    OpenEXR::IlmThread
#
# For OpenEXR 2.x, it will establish the following imported targets:
#
#    IlmBase::Imath
#    IlmBase::Half
#    IlmBase::Iex
...
#    OpenEXR::IlmImf
#
# For all versions are the following CMake variables:
#
...
if (OPENEXR_FOUND)
    ...
    set_target_properties(OpenEXR::IlmImf PROPERTIES
        ...
        INTERFACE_COMPILE_DEFINITIONS "${_OPENEXR_CFLAGS_OTHER}"
        INTERFACE_INCLUDE_DIRECTORIES "${ILMBASE_INCLUDE_PATH}"
        INTERFACE_LINK_LIBRARIES "${OPENEXR_HALF_LIBRARY};${OPENEXR_IEX_LIBRARY};${OPENEXR_IMATH_LIBRARY};${ILMBASE_PTHREADS};${ZLIB_LIBRARIES}"
    )

    add_library(IlmBase::Imath UNKNOWN IMPORTED)
    set_target_properties(IlmBase::Imath PROPERTIES
        IMPORTED_LOCATION "${OPENEXR_IMATH_LIBRARY}"
        INTERFACE_COMPILE_DEFINITIONS "${_ILMBASE_CFLAGS_OTHER}"
        INTERFACE_INCLUDE_DIRECTORIES "${OPENEXR_INCLUDE_PATH}"
        INTERFACE_LINK_LIBRARIES "${OPENEXR_IEX_LIBRARY}"
    )
    ...
    set_target_properties(IlmBase::IlmThread PROPERTIES
        ...
        INTERFACE_COMPILE_DEFINITIONS "${_ILMBASE_CFLAGS_OTHER}"
        INTERFACE_INCLUDE_DIRECTORIES "${OPENEXR_INCLUDE_PATH}"
        INTERFACE_LINK_LIBRARIES "${ILMBASE_PTHREADS}"
    )
endif ()
